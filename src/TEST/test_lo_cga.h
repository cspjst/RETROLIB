...
void test_lo_cga() {
    ...
    getchar();
    cga_lo_set_palette(CGA_PALETTE_0);
    cga_lo_set_background_colour(CGA_BLACK);
    test_lo_screen_blt();
    printf("CGA_GRAPHICS_4_GRAY_320X200\nCGA_PALETTE_0\n");
    getchar();
    cga_lo_set_palette(CGA_PALETTE_0_HI);
    cga_lo_set_background_colour(CGA_BLACK);
    test_lo_screen_blt();
    printf("CGA_GRAPHICS_4_GRAY_320X200\nCGA_PALETTE_0_HI\n");
    getchar();
    cga_lo_set_palette(CGA_PALETTE_1);
    cga_lo_set_background_colour(CGA_BLACK);
    test_lo_screen_blt();
    printf("CGA_GRAPHICS_4_GRAY_320X200\nCGA_PALETTE_1\n");
    getchar();
    cga_lo_set_palette(CGA_PALETTE_1_HI);
    cga_lo_set_background_colour(CGA_BLACK);
    test_lo_screen_blt();
    printf("CGA_GRAPHICS_4_GRAY_320X200\nCGA_PALETTE_1_HI\n");
    getchar();
    cga_lo_set_palette(CGA_PALETTE_2);
    cga_lo_set_background_colour(CGA_BLACK);
    test_lo_screen_blt();
    printf("CGA_GRAPHICS_4_GRAY_320X200\nCGA_PALETTE_2\n");
    getchar();
    cga_lo_set_palette(CGA_PALETTE_2_HI);
    cga_lo_set_background_colour(CGA_BLACK);
    test_lo_screen_blt();
    printf("CGA_GRAPHICS_4_GRAY_320X200\nCGA_PALETTE_2_HI\n");
    getchar();
